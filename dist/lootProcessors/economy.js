...
exports.generateEconomyHtml = void 0;
const promises_1 = __importDefault(require("fs/promises"));
const keepSellingPriceItems = [
    'Depleted_Uranium',
    'Depleted_Uranium_Container',
    'Graphite',
];
const keepPurchasePriceItems = [];
const generateEconomyHtml = (sourceFile = 'data/EconomyOverride_src.json', destinationFile = 'data/EconomyOverride.json', htmlFile = 'data/index.html') => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const key of keys) {
        ...
        rows.push('<tr class="header"><td style="text-align:center;font-size:1.2em;line-height:1.5em;font-weight:bold;" colspan="5">' +
            key +
            '</td></tr>');
...
exports.generateEconomyHtml = generateEconomyHtml;
