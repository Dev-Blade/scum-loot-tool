...
exports.spawnersConfig = {
    pathSpawnersOverride: path_1.default.join(_lootPaths_1.pathSpawnersOverride, '-LootSector'),
    skipFilePatterns: [],
    defaults: {
    ...
    filter: {
        ...
        'Buildings-Bedroom-Residential-Examine_Drawer': {
            Nodes: {
                Other: {
                    postAdd: [spawnersPacks_1.spawnersPacks.Nodes.livingRoomWeapns, spawnersPacks_1.spawnersPacks.Nodes.livingRoomWeapns],
                },
            },
        },
        'Buildings-Livingroom-Examine_Drawers': {
            Nodes: {
                'Items.Misc': {
                    postAdd: [spawnersPacks_1.spawnersPacks.Nodes.livingRoomWeapns],
                },
            },
        },
    },
};
//# sourceMappingURL=spawnersGoodSectorConfig.js.map