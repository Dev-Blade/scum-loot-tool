...
exports.processSpawners = void 0;
...
const spawnersBadSectorConfig_1 = require("./spawnersConfigs/spawnersBadSectorConfig");
const spawnersGoodSectorConfig_1 = require("./spawnersConfigs/spawnersGoodSectorConfig");
const spawnersConfig = {
    bad: spawnersBadSectorConfig_1.spawnersConfig,
    good: spawnersGoodSectorConfig_1.spawnersConfig,
};
const processSpawners = (which) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (const file of files) {
            ...
            if (!skip) {
                ...
                if (initialDamage === 0)
                    initialDamage = Math.random() * defaults.defaultInitialDamageRandomMaxMultiplierIfZero;
                if (!isNaN(initialDamage)) {
                    initialDamage = Math.round(initialDamage * defaults.defaultInitialDamageMultiplier);
                    if (initialDamage > 95) {
                        initialDamage = 95;
                    }
                    if (defaults.defaultInitialMinDamage > 0 && initialDamage < defaults.defaultInitialMinDamage)
                ...
                if (!isNaN(randomDamage)) {
                    ...
                    if (defaults.defaultRandomMinDamage > 0 && randomDamage < defaults.defaultRandomMinDamage)
            ...
            const e = yield (0, fileUtils_2.ensureDirectory)(pathSpawnersOverride);
            if (e === false)
                throw new Error('Could not create target directory ' + pathSpawnersOverride);
            const destName = path_1.default.join(pathSpawnersOverride, file);
...
exports.processSpawners = processSpawners;
