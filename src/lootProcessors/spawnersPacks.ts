...
export const sentryPacks: SpawnersPacks = {
  FixedItems: {
    A: ['Cal_5_56x45mm_Ammobox', 'Cal_5_56x45mm_Ammobox', 'Cal_5_56x45mm_Ammobox', 'Cal_5_56x45mm_Ammobox', 'Cal_5_56x45mm_Ammobox'],
    B: ['Cal_7_62x39mm_Ammobox', 'Cal_7_62x39mm_Ammobox', 'Cal_7_62x39mm_Ammobox', 'Cal_7_62x39mm_Ammobox', 'Cal_7_62x39mm_Ammobox'],
...
export const spawnersPacks2: SpawnersPacks = {
  FixedItems: {
    ...
    Locks1: ['Lock_Item_Advanced', 'Lock_Item_Advanced', 'Lock_Item_Advanced', 'Lock_Item_Advanced', 'Lock_Item_Advanced'],
    Locks2: ['Lock_Item_Advanced', 'Lock_Item_Advanced', 'Lock_Item_Advanced'],
    LockSecurity1: ['Lock_Security_Lvl3', 'Lock_Security_Lvl3', 'Lock_Security_Lvl3'],
    LockSecurity2: ['Lock_Security_Lvl2', 'Lock_Security_Lvl2', 'Lock_Security_Lvl2'],
    // Repair: [
    //   "Electrician_Tools",
...
export const spawnersPacks: SpawnersPacks = {
  FixedItems: {
    ASVAL: ['Weapon_AS_Val', 'WeaponSights_RedDot_CA401B', 'ScopeRail_AK47', 'WeaponFlashlight_AS_Val'],
    VSS: ['Weapon_VSS_VZ', 'WeaponScope_ACOG_01', 'ScopeRail_AK47', 'WeaponFlashlight_AS_Val'],
    Bow: ['BowSilencer_SlipOn', 'BowSilencer_SlipOn', 'Recurve_Bow_70', 'Military_Quiver_01', 'Carbon_BroadHead_Arrow', 'Carbon_BroadHead_Arrow', 'Carbon_BroadHead_Arrow'],
    SF19: ['Weapon_SF19', 'Magazine_SF19', 'Magazine_SF19', 'Magazine_SF19', 'Cal_9mm_Ammobox', 'Cal_9mm_Ammobox', 'WeaponSuppressor_Handgun', 'WeaponSights_Wasp'],
    MP5: ['Weapon_MP5', 'Magazine_MP5', 'Magazine_MP5', 'Cal_9mm_Ammobox', 'Cal_9mm_Ammobox', 'WeaponSuppressor_MP5', 'MP5_Rail_Short', 'WeaponSights_RedDot_CA401B'],
    MP5Small: ['Weapon_MP5', 'Magazine_MP5', 'Cal_9mm_Ammobox', 'MP5_Rail_Short'],

    MP5K: ['Weapon_MP5_K', 'Magazine_MP5', 'Magazine_MP5', 'Cal_9mm_Ammobox', 'Cal_9mm_Ammobox', 'MP5_Rail_Short', 'WeaponSights_RedDot_CA401B', 'WeaponSuppressor_MP5'],
    ...
    Deagle: ['Weapon_Deagle_357', 'Magazine_DEagle_357', 'Magazine_DEagle_357', 'Cal_357_Ammobox', 'Cal_357_Ammobox', 'WeaponFlashlight_DesertEagle', 'WeaponSights_Deagle_RedDot'],
  ...
  Nodes: {
    livingRoomWeapns: {
      Rarity: 'Rare',
      Ids: ['ItemLootTreeNodes.LivingRoom.Other.Weapons'],
    },
  },
};
